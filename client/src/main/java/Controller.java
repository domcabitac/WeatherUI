...
public class Controller {
    ...
    ObservableList<String> cityMenuItems = FXCollections.observableArrayList("Oshawa, CA", "Mississauga, CA", "Guelph, CA", "Ottawa, CA","Kingston, CA", "Markham, CA", "Scarborough, CA", "Biysk, RU", "Hong Kong, HK", "Northampton, GB", "Dubai, AE", "Akita, JP");
